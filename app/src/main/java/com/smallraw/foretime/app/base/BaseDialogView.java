...
public class BaseDialogView extends Dialog {
  ...
  public void showAtViewDown(View view) {
    ...
    int viewWidthHalf = view.getWidth() / 2;

    ViewGroup parentView = findViewById(R.id.patent_view);
    TriangleView arrow = parentView.findViewById(R.id.doalog_arrow_bottom);
    ...
    int windowViewX = location[0];
    int windowViewY = location[1];
