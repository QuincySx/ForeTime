...
public class OverScrollView extends FrameLayout implements View.OnTouchListener {
    ...
    private View findFocusableViewInMyBounds(
            final boolean topFocus, final int top, View preferredFocusable) {
        /*
     ...
     * view by one page up or down and give the focus to the topmost/bottommost component in the new
            ...
            if (topOfVisibleView < paddingTop || topOfVisibleView > contentBottom - displayHeight) {
                if (topOfVisibleView < paddingTop) {
                    mScroller.startScroll(
                            0, topOfVisibleView, 0, paddingTop - topOfVisibleView, 1000);
