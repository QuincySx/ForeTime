...
import com.smallraw.foretime.app.common.CardScaleHelper
...
class TaskInfoActivity : BaseTitleBarActivity() {
    companion object {
        ...
        @JvmStatic
        fun start(activity: Context, taskId: Long) {
    ...
    private fun newShareView(): View {
        ...
        val layoutParams = ViewGroup.LayoutParams(AutoSizeUtils.dp2px(this, 32F), AutoSizeUtils.dp2px(this, 32F))
        right.layoutParams = layoutParams
//        right.setPadding(AutoSizeUtils.pt2px(this, 6F), AutoSizeUtils.pt2px(this, 6F), AutoSizeUtils.pt2px(this, 6F), AutoSizeUtils.pt2px(this, 6F))
